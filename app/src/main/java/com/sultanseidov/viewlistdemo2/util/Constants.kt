...
object Constants {
    ...
    const val VIEW_LIST_MOVIES_TABLE = "view_list_movies_table"
    const val VIEW_LIST_TV_SHOWS_TABLE = "view_list_tvshows_table"

    const val VIEW_LIST_PINS_TABLE = "view_list_pins_table"
