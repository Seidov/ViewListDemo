...
interface IMovieRepository {
    ...
    fun getDiscoveryFlowByTag(tag: String, mediaType: String, genres: String): Flow<PagingData<DiscoveryMediaEntity>>
    fun searchMovies(query: String): Flow<PagingData<MovieModel>>

    // Remote Details
    suspend fun getMovieDetails(movieId: Long): MovieModel
    suspend fun getMovieKeywords(movieId: Long): List<String>
    ...
    // Pins
    fun getAllPinsViewList(): Flow<List<PinViewListModel>>
